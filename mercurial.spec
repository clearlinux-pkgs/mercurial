...
Source0  : https://www.mercurial-scm.org/release/mercurial-6.8.2.tar.gz
Source1  : https://www.mercurial-scm.org/release/mercurial-6.8.2.tar.gz.asc
Source2  : A11E01CD0E05D956.pkey
Source3  : hgk.rc
...
grep -E '^\[GNUPG:\] (GOODSIG|EXPKEYSIG) A11E01CD0E05D956' gpg.status
%setup -q -n mercurial-6.8.2
cd %{_builddir}/mercurial-6.8.2
%patch -P 1 -p1
%patch -P 2 -p1
%patch -P 3 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1730231517
...
cp %{_builddir}/mercurial-%{version}/mercurial/thirdparty/attr/LICENSE %{buildroot}/usr/share/package-licenses/mercurial/243e9dd038d3d68c67d42c0c4ba80622c2a56246 || :
...
cp %{_builddir}/mercurial-%{version}/mercurial/thirdparty/tomli/LICENSE %{buildroot}/usr/share/package-licenses/mercurial/9da6ca26337a886fb3e8d30efd4aeda623dc9ade || :
...
/usr/share/package-licenses/mercurial/243e9dd038d3d68c67d42c0c4ba80622c2a56246
/usr/share/package-licenses/mercurial/4cc77b90af91e615a64ae04893fdffa7939db84c
/usr/share/package-licenses/mercurial/9da6ca26337a886fb3e8d30efd4aeda623dc9ade
