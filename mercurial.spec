...
Source0  : https://www.mercurial-scm.org/release/mercurial-6.6.tar.gz
Source1  : https://www.mercurial-scm.org/release/mercurial-6.6.tar.gz.asc
Source2  : hgk.rc
...
%prep
%setup -q -n mercurial-6.6
cd %{_builddir}/mercurial-6.6
%patch -P 1 -p1
%patch -P 2 -p1
%patch -P 3 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1700608462
